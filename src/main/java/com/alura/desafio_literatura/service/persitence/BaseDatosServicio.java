package com.alura.desafio_literatura.service.persitence;
...
import com.alura.desafio_literatura.repository.AutorRepository;
import com.alura.desafio_literatura.repository.LibroRepository;
...
public class BaseDatosServicio {
    ...
    @Autowired
    public BaseDatosServicio(LibroRepository libroRepositorio, AutorRepository autorRepositorio) {
        this.libroRepositorio = libroRepositorio;
        this.autorRepositorio = autorRepositorio;
    }

    public void agregarLibro(Libro libroEntidad) {
        try {
    ...
    public void listarAutoresPorAno() {
        ...
        List<Autor> respuestaBaseDatos = autorRepositorio.autoresPorAno(anoBuscado);
    ...
    public void listarLibrosPorIdioma() {
        ...
        // Ejecutar la consulta a la base de datos.
        List<Libro> respuestaBaseDatos = libroRepositorio.librosPorIdioma(idiomaBuscado);
